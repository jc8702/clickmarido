...
import {
  ...
  finishServiceOrder,
  updateOrderStatus,
} from '@/lib/api/modules/service-orders';
    ...
    <div className="bg-card border rounded-lg shadow-sm p-6 w-full max-w-4xl mx-auto">
      ...
      {activeTab === 'Resumo' && (
        <div className="space-y-4 text-sm">
          <p>
            <strong>OS Número:</strong> #{os.number}
          </p>
          <p>
            <strong>Cliente:</strong> {os.client?.name}
          </p>
          <p>
            <strong>Técnico Atribuído:</strong> {os.technician?.name || 'Pendente'}
          </p>
          ...
          <p>
            <strong>Valor Total:</strong> R$ {os.totalValue.toFixed(2)}
          </p>
          <hr />
        ...
        <div className="space-y-4">
          <div className="flex gap-2">
            ...
            <button
              ...
              className="bg-secondary text-secondary-foreground px-4 rounded"
            >
              Adicionar
            </button>
          </div>
      ...
      {activeTab === 'Encerramento' && (
        <div className="space-y-4 text-center p-6">
          {os.status === 'Concluído' ? (
              ...
              <div className="mt-6 border-t border-green-200 pt-4">
                <button
                  onClick={() => {
                    ...
                    const phone =
                      (os.client as Record<string, string>)?.whatsapp ||
                      (os.client as Record<string, string>)?.phone ||
                      '';
            ...
            <div>
              <p className="mb-4">
                Confirme que todos os serviços foram executados e solicite a assinatura do cliente.
              </p>
              ...
              <button
                ...
                className="bg-primary text-primary-foreground font-bold py-3 px-8 rounded-lg shadow-lg hover:scale-105 transition-transform"
              >
