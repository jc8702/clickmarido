...
export function ActionCards() {
  return (
    <div
      className="grid gap-6 sm:grid-cols-2 mt-8 animate-in-slide"
    ...
    >
      <Card className="glass-card flex flex-col justify-between overflow-hidden relative min-h-[200px] border-border/50">
        <CardContent className="p-8 relative z-10 flex flex-col h-full justify-between">
          <div>
            <Badge className="bg-emerald-500/10 text-emerald-600 dark:text-emerald-500 border-emerald-500/20 mb-4">
              Saúde Financeira
            </Badge>
          ...
          <Link href="/relatorios">
            <Button className="w-fit mt-6 bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg">
              Acessar Relatórios <ArrowRight className="w-4 h-4 ml-2" />
            </Button>
          </Link>
        </CardContent>
      ...
      <Card className="glass-card flex flex-col justify-between overflow-hidden relative min-h-[200px] border-border/50">
        <CardContent className="p-8 relative z-10 flex flex-col h-full justify-between">
          <div>
            <Badge className="bg-blue-500/10 text-blue-600 dark:text-blue-500 border-blue-500/20 mb-4">
              Pipeline de Vendas
            </Badge>
