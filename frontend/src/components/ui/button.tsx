  ...
  (
    ...
    return (
      <button
        ...
        aria-label={
          ariaLabel || (isIconOnly ? (typeof icon === 'string' ? icon : undefined) : undefined)
        }
        ...
        className={cn(
          ...
          variant === 'ghost' &&
            'bg-transparent text-foreground hover:bg-zinc-100 dark:hover:bg-zinc-800 focus-visible:ring-border',
          variant === 'outline' &&
            'border border-border bg-transparent hover:bg-zinc-100 dark:hover:bg-zinc-800 text-foreground focus-visible:ring-border',
          variant === 'link' &&
