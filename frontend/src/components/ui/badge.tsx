...
export interface BadgeProps extends React.HTMLAttributes<HTMLSpanElement> {
  variant?: 'primary' | 'default' | 'secondary' | 'success' | 'warning' | 'danger' | 'destructive' | 'info' | 'outline';
}
  ...
  return (
    <span
      className={cn(
        ...
        (variant === 'primary' || variant === 'default') && 'border-transparent bg-primary/10 text-primary hover:bg-primary/20',
        ...
        (variant === 'danger' || variant === 'destructive') && 'border-transparent bg-destructive/10 text-destructive hover:bg-destructive/20',
