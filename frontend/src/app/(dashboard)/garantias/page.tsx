      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Monitoramento de garantias de serviços prestados (30, 60 e 90 dias).
          </p>
        </div>
        <button
          onClick={() => setShowModal(true)}
          className="flex items-center gap-2 bg-emerald-500 text-white px-4 py-2 rounded-md hover:bg-emerald-600 font-medium"
        >
      ...
      <div className="glass-card border-border/50 rounded-lg overflow-x-auto shadow-sm">
        <table className="w-full text-sm text-left">
          <thead className="bg-muted/50 border-b border-border/50">
            <tr>
              <th className="px-6 py-4 font-bold text-muted-foreground uppercase text-xs">
                Status
              </th>
              <th className="px-6 py-4 font-bold text-muted-foreground uppercase text-xs">
                Cliente
              ...
              <th className="px-6 py-4 font-bold text-muted-foreground uppercase text-xs text-right">
                Ações
              </th>
            </tr>
          </thead>
                ...
                return (
                  ...
                  >
                    <td className="px-6 py-4">
                      <span
                        className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full font-bold text-xs ${visuals.color}`}
                      >
          ...
          <div className="glass-card border border-border/50 rounded-2xl shadow-xl w-full max-w-md p-6">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-bold flex items-center gap-2">
                <Shield className="w-5 h-5 text-emerald-500" /> Registrar Garantia
              </h3>
              <button
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-background border rounded p-2 outline-none focus:border-emerald-500"
                >
              ...
              <div>
                <label className="block text-sm font-medium mb-1">
                  Descrição do Serviço Coberto (Opcional)
                </label>
                <textarea
                  rows={3}
                  ...
                  className="w-full bg-background border rounded p-2 outline-none focus:border-emerald-500"
                  placeholder="Ex: Conserto da fiação do painel principal"
                />
              </div>
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="w-full bg-emerald-500 text-white font-bold py-2 rounded hover:bg-emerald-600 transition-colors"
                >
