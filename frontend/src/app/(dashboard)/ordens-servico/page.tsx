...
function OrdensServicoPageInner() {
  const { orders, total, page, totalPages, search, loading, setSearch, setPage } =
    useServiceOrders();
        ...
        {loading ? (
          ...
          <Card className="flex flex-col items-center justify-center p-16 text-center border-dashed border-zinc-900 bg-zinc-950/20">
            ...
            <p className="text-sm text-zinc-500 mt-1 max-w-sm">
              As ordens de serviço são geradas automaticamente ao aprovar um orçamento. Vá em
              Orçamentos e aprove uma proposta para gerar uma OS.
            </p>
