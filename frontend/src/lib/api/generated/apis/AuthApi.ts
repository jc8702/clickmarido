...
export class AuthApi extends runtime.BaseAPI {
   ...
   */
  async authControllerForgotPasswordRequestOpts(
    requestParameters: AuthControllerForgotPasswordRequest,
  ...
  /**
   */
  async authControllerForgotPasswordRaw(
    requestParameters: AuthControllerForgotPasswordRequest,
   ...
   */
  async authControllerLogoutRequestOpts(
   ...
   */
  async authControllerRefreshRequestOpts(
    requestParameters: AuthControllerRefreshRequest,
  ): Promise<runtime.RequestOpts> {
    if (requestParameters['body'] == null) {
      throw new runtime.RequiredError(
        'body',
   ...
   */
  async authControllerResetPasswordRequestOpts(
    requestParameters: AuthControllerResetPasswordRequest,
  ): Promise<runtime.RequestOpts> {
    if (requestParameters['body'] == null) {
      throw new runtime.RequiredError(
        'body',
  ...
  /**
   */
  async authControllerResetPasswordRaw(
    requestParameters: AuthControllerResetPasswordRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
