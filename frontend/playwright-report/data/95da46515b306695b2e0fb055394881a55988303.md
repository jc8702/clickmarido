...
- Name: financeiro.spec.ts >> Financeiro Flow >> should display financial dashboard
- Location: e2e\financeiro.spec.ts:8:7
...
Locator: getByText(/fluxo de caixa/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/fluxo de caixa/i)
