...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    (0, swagger_1.ApiPropertyOptional)({ description: 'Campo technicianId', example: 'exemplo' }),
    __metadata("design:type", String)
], CreateAppointmentDto.prototype, "technicianId", void 0);
__decorate([
    (0, class_validator_1.IsUUID)('all', { message: 'ID de ordem de serviço inválido' }),
    (0, class_validator_1.IsOptional)(),
    (0, swagger_1.ApiPropertyOptional)({ description: 'Campo serviceOrderId', example: 'exemplo' }),
    __metadata("design:type", String)
